// BuiltinFunctions.ts - Registry of built-in Excel functions
...
/**
 * Criteria matcher used by COUNTIFS, SUMIF, SUMIFS, AVERAGEIF, AVERAGEIFS.
 */
function matchCriteria(val: any, crit: any): boolean {
